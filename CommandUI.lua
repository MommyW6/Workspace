...
do
	...
	function Utility:EnableDragging(Frame, Parent)
		...
		local Main = PlayerGui:FindFirstChild('Visual Command UI Library | .gg/puxxCphTnK').Main
...
function Library:CreateWindow(Properties)
	...
	Utility:Tween(Main, {Size = UDim2.new(0, 1000, 0, 500)}, 0)

	Utility:Tween(Main['IntroText'], {TextTransparency = 0}, 0)


	Utility:Tween(Main['IntroImage'], {ImageTransparency = 0}, 0)

	Utility:Tween(Main['IntroText'], {TextTransparency = 1}, 0)

	Utility:Tween(Main['IntroImage'], {ImageTransparency = 1}, 0)
	]]
